package com.example.cropimagetest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void CameraOpen() {
        ...
        file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM), "testCrop"+ ".jpg");
